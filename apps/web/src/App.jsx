...
// ─── Admin pages — loaded on demand (admin users only) ───────────────────────
      ...
      <div style={{ opacity: appReady ? 1 : 0, transition: "opacity 0.3s ease" }}>
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/checkout"       element={<ProtectedRoute><PublicShell><CheckoutPage /></PublicShell></ProtectedRoute>} />
            <Route path="/checkout/success/:orderId" element={<ProtectedRoute><PublicShell><CheckoutSuccessPage /></PublicShell></ProtectedRoute>} />
