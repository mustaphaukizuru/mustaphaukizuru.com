...
export const SERVICES = [
  ...
  { id: "UKZ-WD-003", categoryCode: "WD", name: "E-commerce Platform Build", tier: 2, audience: ["SMB"], engagement: "Build", duration: "6–12 weeks", pricingModel: "Fixed", status: "active",
    ...
    deliverables: ["Catalog architecture","Cart & checkout","Payment integration (Stripe, MercadoPago, Conekta)","Inventory management","Order fulfillment workflow","Customer account","Admin dashboard","SEO foundations","Deployment"],
    related: [] },
  ...
  { id: "UKZ-WD-007", categoryCode: "WD", name: "Authentication and Payment Integration", tier: 2, audience: ["SMB"], engagement: "Build", duration: "2–4 weeks", pricingModel: "Fixed", status: "active",
    ...
    deliverables: ["OAuth, JWT, or SSO","MFA","RBAC","Stripe / PayPal / MercadoPago / Conekta","Subscription billing","Webhook handling","Admin & user-facing UI","Testing"],
    related: [] },
