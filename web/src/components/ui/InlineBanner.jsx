    ...
    >
      ...
      {onDismiss && (
        <button
          ...
          className="cursor-pointer shrink-0 rounded-md p-1 -m-1 opacity-70 hover:opacity-100 transition-opacity duration-[var(--motion-fast)]"
        >
...
export const Alert = InlineBanner
