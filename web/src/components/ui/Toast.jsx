    ...
    >
      <div className="flex items-start gap-3 rounded-[14px] border border-[var(--color-border-subtle)] bg-[var(--color-surface-card)] px-4 py-3 shadow-[var(--shadow-overlay)]">
        ...
        <div className="min-w-0 flex-1">
          ...
          {action && (
            <button
              ...
              className="cursor-pointer mt-2 text-[13px] font-semibold text-[var(--color-text-link)] hover:text-[var(--color-text-link-hover)] underline-offset-2 hover:underline"
            >
              {action.label}
            </button>
          )}
        ...
        <button
          ...
          className="cursor-pointer shrink-0 rounded-md p-1 -m-1 text-[var(--color-text-muted)] hover:text-[var(--color-text-primary)] hover:bg-[var(--color-surface-elevated)] transition-colors duration-[var(--motion-fast)]"
        >
