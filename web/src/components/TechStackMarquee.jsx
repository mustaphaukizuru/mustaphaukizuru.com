      ...
      <div className="relative">
        ...
        >
          {STACK.map(({ name, Icon, color }) => (
            <span
              key={name}
              className="group inline-flex items-center gap-2.5 rounded-xl border border-charcoal-80/6 bg-white px-4 py-2.5 shadow-[0_2px_8px_rgba(93,63,211,0.04)] transition-all duration-200 hover:-translate-y-0.5 hover:border-charcoal-80/14 hover:shadow-[0_6px_18px_rgba(93,63,211,0.08)]"
              title={name}
            >
              <Icon
