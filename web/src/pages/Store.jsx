...
function StoreToolbar({ search, setSearch, categories, activeCategory, setActiveCategory, sort, setSort, viewMode, setViewMode, total, onReset }) {
  ...
  return (
    <aside
      ...
      className="scroll-mt-24 sticky top-[88px] flex flex-col gap-5 self-start rounded-2xl border border-charcoal-80/10 bg-white p-5 shadow-[var(--shadow-e3)]"
    >
      {/* Header */}
            ...
            return (
              <button
                ...
                className={`flex w-full items-center justify-between rounded-lg px-3 py-2 text-left text-meta font-medium transition-all focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-azure/30 ${
                  active
                    ? "bg-violet text-white shadow-[var(--shadow-lift-1)]"
...
function StoreProductCard({ product }) {
  ...
  return (
    <m.article
      ...
      className="group flex h-full flex-col overflow-hidden rounded-xl border border-charcoal-80/10 bg-white shadow-[var(--shadow-e3)] transition-shadow duration-200 hover:shadow-[0_18px_44px_rgb(var(--color-violet-rgb)/0.10)]"
    >
      <Link
...
function StoreListItem({ product }) {
  ...
  return (
    <div className="flex overflow-hidden rounded-xl border border-charcoal-80/10 bg-white shadow-[var(--shadow-e3)] transition hover:shadow-[var(--shadow-e6)]">
...
function SkeletonCard() {
  return (
    <div className="flex h-full flex-col overflow-hidden rounded-xl border border-charcoal-80/10 bg-white shadow-[var(--shadow-e3)]">
