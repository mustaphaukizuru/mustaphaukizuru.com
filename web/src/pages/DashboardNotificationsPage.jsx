...
function NotificationRow({ notification, onRead, t }) {
  ...
  return (
    <div
      className={`group flex items-start gap-3 rounded-xl border border-charcoal-80/8 px-4 py-3 transition hover:border-violet/20 hover:shadow-[var(--shadow-e4)] ${
...
export default function DashboardNotificationsPage() {
  ...
  return (
    <section className="space-y-5">
      <ProfileTabs />
      {/* Page heading */}
      <header className="rounded-xl border border-charcoal-80/10 bg-white p-6 shadow-[var(--shadow-e4)]">
