...
export default function AdminDashboardPage() {
  ...
  return (
    <section className="space-y-5">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="rounded-xl border border-charcoal-80/10 bg-white shadow-[var(--shadow-e3)] lg:col-span-2">
      ...
      {/* ── 7 · Quick actions row ──────────────────────────────────────── */}
      <div className="rounded-xl border border-charcoal-80/10 bg-white p-4 shadow-[var(--shadow-e3)]">
          ...
          {[
            ...
            <Link
              ...
              className={`group flex items-center gap-2 rounded-lg px-3 py-2.5 text-micro font-semibold transition focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-azure/30 focus-visible:ring-offset-2 ${
                primary
                  ? "bg-violet text-white hover:bg-violet-deep hover:-translate-y-0.5 hover:shadow-[var(--shadow-lift-4)]"
